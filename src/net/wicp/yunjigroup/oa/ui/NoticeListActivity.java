 ...
 * @TODO
 */
public class NoticeListActivity extends BaseActivity implements OnClickListener, OnItemClickListener, OnRefreshListener{
    public static final String TAG = "通知公告";
    ...
    class NoticeListTask extends AsyncTask<Void, Void, Void>{
        ...
        protected Void doInBackground( Void... params ) {
            noticeList = NetEngine.getInstance(mContext).getNoticeList();
            return null;
        }
    ...
    public void onItemClick( AdapterView<?> parent, View v, int position, long arg3 ) {
        startActivity(new Intent(mContext, NoticeDetailActivity.class).putExtra("noticeSimple", mListAdapter.getItem(position-1)));
    }
