...
public class MeetingDetailActivity extends BaseActivity implements OnClickListener{
    public static final String TAG = "会议详情";
    ...
    class MeetingDetailTask extends AsyncTask<Void, Void, Void>{
        ...
        protected Void doInBackground( Void... params ) {
            noticeDetail = NetEngine.getInstance(mContext).getMeetingDetail(noticeSimple.getId(), noticeSimple.getCard());
            return null;
        }
